...
cursor.execute("INSERT INTO students (name, year_group,  favourite_subject) VALUES (?, ?)", ("Leo", 12, "Math"))
cursor.execute("INSERT INTO students (name, year_group  , favourite_subject) VALUES (?, ?)", ("Jimmy", 8, "Science"))
