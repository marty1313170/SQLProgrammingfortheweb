...
cursor.execute("INSERT INTO students (name, year_group) VALUES (?, ?)", ("James", 10, ))
cursor.execute("INSERT INTO students (name, year_group) VALUES (?, ?)", ("Leo", 12, ))
cursor.execute("INSERT INTO students (name, year_group  ) VALUES (?, ?)", ("Jimmy", 8,))
